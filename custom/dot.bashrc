...
# For git commits
export GIT_AUTHOR_NAME='David C Wang'
export GIT_AUTHOR_EMAIL='davwang4@cisco.com'
export GIT_COMMITTER_NAME='David C Wang'
export GIT_COMMITTER_EMAIL='dcwangmit01@gmail.com'
